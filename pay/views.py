...
# class PaymentSuccessView(APIView):
#     def get(self, request):
#         # Вам также нужно перенаправить пользователя на страницу оплаты Stripe
#         return redirect("URL_вашей_страницы_успешной_оплаты")

# class PaymentCancelView(APIView):
#     def get(self, request):
#         # Вам также нужно перенаправить пользователя на страницу отмены оплаты
#         return redirect("URL_вашей_страницы_отмены_оплаты")
